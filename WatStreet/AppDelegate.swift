...
let logger:Logboard = Logboard.with("com.watstreet.ios")

@UIApplicationMain
class AppDelegate: UIResponder, UIApplicationDelegate {

    var window: UIWindow?
    var currentStreetInfo: [String:Any]!
    var currentStreetKey: String!
    var currentFeeds: [[String:Any]]!
    ...
    func application(_ application: UIApplication, didFinishLaunchingWithOptions launchOptions: [UIApplicationLaunchOptionsKey: Any]?) -> Bool {
        ...
        GMSPlacesClient.provideAPIKey("AIzaSyChR2hjgwCusz-DFCbOvUWvEaOFp2EcYpo")
        IQKeyboardManager.sharedManager().enable = true
        IQKeyboardManager.sharedManager().shouldShowToolbarPlaceholder = false
        
        // Setup Mic For Live Streaming
        do {
